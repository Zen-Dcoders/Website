...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-r from-black to-[#2C3E50] text-white">
      {/* Main Footer Content */}
      <div className="container mx-auto px-4 py-8">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="flex items-center mb-4 md:mb-0">
            <img 
              src="https://res.cloudinary.com/dn2609yjq/image/upload/c_crop,ar_16:9/v1737056403/logo_dark_ylpj1z.png" 
              alt="ZenDcoders Logo" 
              className="h-12 mr-4"
            />
            <span>© 2024 ZenDcoders - All Rights Reserved</span>
            <button 
              onClick={() => setShowTerms(!showTerms)}
              className="hover:text-gray-300 transition flex items-center ml-5"
            >
              Terms & Conditions
              {showTerms ? (
          ...
          <div className="flex space-x-6">
            <a href="https://www.instagram.com/zendcoders/" className="hover:text-gray-300 transition">Instagram</a>
            <a href="https://linkedin.com/in/zendcoders-admin-a2948b339" className="hover:text-gray-300 transition">LinkedIn</a>
            
          </div>
        </div>

        {/* Expandable Terms & Conditions */}
        <div className={`transition-all duration-300 overflow-hidden ${showTerms ? 'max-h-[2000px] mt-6' : 'max-h-0'}`}>
          <div className="bg-white text-gray-800 rounded-lg p-6 shadow-lg">
            <h2 className="text-2xl font-bold mb-4">Terms & Conditions</h2>
            
            <div className="prose max-w-none">
              <p className="mb-4">
                These Terms and Conditions, along with the Privacy Policy or other terms ("Terms"), constitute a binding agreement by and between ZenDcoders ("Website Owner," "we," "us," or "our") and you ("you" or "your") and relate to your use of our website, goods (as applicable), or services (as applicable) (collectively, "Services").
              </p>
              ...
              <h3 className="text-lg font-semibold mb-3">Terms of Use:</h3>
              <ul className="list-disc pl-6 space-y-2 mb-6">
                ...
                <li>All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in Tadepalli, Andhra Pradesh.</li>
